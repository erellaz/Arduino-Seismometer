...
For simplicity, average performance use the simple tension divider. For excellent performances, add the operational amplifier (for example an LM 358) in follower mode, making this a better and only slightly more involved built. 
